    ...
    public function store(Request $request){
        ...
        for ($i=0; $i<7; ++$i){
            ...
            if($morning_start[$i] > $morning_end[$i]){
                ...
                $errors[] ='Inconsistencia en el intervalo de las horas del turno de la mañana '.$this->days[$i].'.';
            }
            if($afternoon_start [$i] > $afternoon_end [$i]){

                $errors[] ='Inconsistencia en el intervalo de las horas del turno de la tarde '.$this->days[$i].'.';
            }
